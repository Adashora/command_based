...
public class Intake extends SubsystemBase {
  ...
  public Intake() {
    ...
    Intake_left = new SparkMax(Constants.left_intake_ID, MotorType.kBrushless); //deifning motors
    Intake_right = new SparkMax(Constants.right_intake_ID, MotorType.kBrushless);
